...
=============================
	...
	{\bf Definition:}\\[.3em]
$G_\sigma(x)=\frac1{2\pi\sigma^2}e^{-\|x\|^2/2\sigma^2}$
...
% TODO: for each blur, compute a sequence (G_σ-δ)*(σ^2/2) for a decreasing
% sequence of σ.  These sequene of images should converge to a laplacian
% kernel.  Plot these sequences as lines in a feature space spanned by the
% five-point laplacian, the fourier laplacian, and some trivial shit like 0 or
% the dirac (or even, some other meaningful point, try to rotate the shit in
% Nd)
