...
%MAKE all : $(M:%=r1000_g3_%.png)
%MAKE o/r1000_g3_%.png: t/r1000_g3_%.npy; downsa v 4 $^ | qeasy {-,}0.01 - $@
%MAKE t/r1000_g3_%.npy   : t/r1000.npy ; python gblurs.py $* -i $^ -o $@ -s 3
%MAKE t/r1000_g30_%.npy  : t/r1000.npy ; python gblurs.py $* -i $^ -o $@ -s 30
%MAKE t/r1000_g100_%.npy : t/r1000.npy ; python gblurs.py $* -i $^ -o $@ -s 100
